...
abstract class AbstractDayTest extends WordSpec with Matchers with BeforeAndAfterEach with PrivateMethodTester {
  ...
  val yetAnotherMeasurement = Measurement(5, BeforeOrAfterMeal.AFTER_MEAL, "pear", 3, "no comments")
  val measurementOnDateAlpha = Measurement(10, localDateAlpha, BeforeOrAfterMeal.BEFORE_MEAL, "banana", 1, "no comments")
  val anotherMeasurementOnDateAlpha = Measurement(20, localDateAlpha, BeforeOrAfterMeal.BEFORE_MEAL, "bigger banana", 1, "no comments")
  val measurementOnDateBeta = Measurement(30, localDateBeta, BeforeOrAfterMeal.BEFORE_MEAL, "grapefruit", 1, "no comments")
  val aMeasurementForToday = Measurement(20, today, BeforeOrAfterMeal.BEFORE_MEAL, "grape", 1, "no comments")
  val anotherMeasurementForToday = Measurement(20, today, BeforeOrAfterMeal.BEFORE_MEAL, "peach", 1, "no comments")
